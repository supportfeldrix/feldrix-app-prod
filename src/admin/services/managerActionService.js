...
const FOLLOWUPS = {
  ...
  reports:       ["Generate Executive Report", "Generate Revenue Report", "Export PDF"],
...
const NAVIGATE_INTENTS = [
  ...
  { keys: ["report", "export", "report centre", "generate report", "export centre"], page: "reports" },
  { keys: ["analytic", "chart", "graph", "hub"], page: "analytics" },
